...
V2Ray 的核心组件是一个命令行程序，它可以运行在多个平台上，并使用同样格式的参数和配置文件。预编译的核心程序可以在 [Release](https://github.com/v2ray/v2ray-core/releases) 中下载到，解压即可运行。

如果你需要图形化界面的软件，请使用[第三方客户端](3rd_party.md)。
